...
CONFIG_DIR="/home/umityigitbsrn/Desktop/umityigitbsrn/certified-unlearning-surr-data/configs/offcov"

# Python script to run with each configuration file
PYTHON_SCRIPT="/home/umityigitbsrn/Desktop/umityigitbsrn/certified-unlearning-surr-data/synthetic_main.py"
